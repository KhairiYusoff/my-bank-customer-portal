...
import * as ProfileEnums from "@/features/profile/types/profile";
...
export const profileFormSchema = yup.object({
  ...
  residencyStatus: yup
    ...
    .oneOf(["citizen", "permanent resident", "foreigner"])
    .optional(),
  job: yup.string().optional(),
  employerName: yup.string().optional(),
  employmentType: yup
    .mixed<EmploymentTypeType>()
    .oneOf(["salaried", "self-employed", "unemployed", "retired", "student"])
    .optional(),
  salary: yup
    .mixed<SalaryRangeType>()
    .oneOf([
      "<1000",
      "1000-2999",
      "3000-4999",
    ...
    .optional(),
  accountType: yup
    .mixed<AccountTypeType>()
    .oneOf(["savings", "current", "fixed deposit"])
    .optional(),
  purposeOfAccount: yup
    .mixed<PurposeOfAccountType>()
    .oneOf([
      "savings",
      "salary credit",
      "investment",
  ...
  nextOfKin: yup
    .object({
      ...
      relationship: yup
        .mixed<NextOfKinRelationshipType>()
        .oneOf([
          "parent",
          "spouse",
          "child",
